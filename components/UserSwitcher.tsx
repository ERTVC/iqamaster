...
const UserSwitcher: React.FC = () => {
  ...
  const roles = [
    { id: Role.IQA, label: 'IQA', icon: Shield, user: users.find(u => u.username === 'iqa') },
    { id: Role.HOD, label: 'HOD 1', icon: UserCheck, user: users.find(u => u.username === 'hod1') },
    { id: Role.Trainer, label: 'Trainer 1', icon: GraduationCap, user: users.find(u => u.username === 'trainer1') },
    { id: Role.ClassRep, label: 'Class Rep 1', icon: Users, user: users.find(u => u.username === 'classrep1') },
  ];
